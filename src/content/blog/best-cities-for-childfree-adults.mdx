...
1. **Adult-focused amenities (20%)** — Restaurant and bar density per capita, sourced from Yelp's State of the Restaurant Industry report and WalletHub's Best Foodie Cities rankings. Cities with higher concentrations of dining, nightlife, and cultural venues scored higher.

2. **Career opportunities (20%)** — Job market strength and median household income data from the U.S. Bureau of Labor Statistics and the U.S. Census Bureau's American Community Survey. We prioritized cities with strong growth in industries that attract young professionals, particularly tech, healthcare, and creative sectors.

3. **Dating scene (15%)** — Proportion of single and childfree adults using U.S. Census fertility data and Pew Research surveys on childlessness. Cities with higher percentages of adults ages 25–44 without children and active social scenes scored higher.

4. **Cost of living (15%)** — Cost of living indices from Numbeo and the Bureau of Labor Statistics' Consumer Price Index by metro area. We evaluated affordability relative to median income, not raw cost alone — a city can be expensive but still score well if salaries keep pace.

5. **Outdoor activities (15%)** — Proximity to natural amenities (beaches, mountains, trails, parks) based on the Trust for Public Land's ParkScore Index and geographic assessment.

6. **Walkability and transit (15%)** — Walk Score and Transit Score data for each metro area. Cities with higher walkability reduce car dependence, which aligns with childfree lifestyles that prioritize urban convenience.
